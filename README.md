...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Igor-hrm.github.io/react_static-list-of-posts-js/) and add it to the PR description.
